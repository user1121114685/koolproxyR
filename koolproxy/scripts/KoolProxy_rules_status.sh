...
fanboy_rules_local=`cat $KSROOT/koolproxy/data/rules/fanboy-ultimate.txt  | sed -n '4p'|awk '{print $3,$4}'`
fanboy_nu_local=`grep -E -v "^!" $KSROOT/koolproxy/data/rules/fanboy-ultimate.txt | wc -l`
